...
На модули, которые еще не вышли, можно подписаться и получить уведомление о релизе сразу на имейл.""").format(my_name=my_name, friend_name=friend_name, website=website, email_from=email_from, email_to=email_to)
